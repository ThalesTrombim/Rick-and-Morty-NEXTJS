...
export default function Home({ list }){
  return (
    <div id="Container" className="text-white w-full h-auto bg-homebg-dark flex flex-col">
      <div className="w-full h-5/6 bg-cover md:bg-center bg-right"
       style={{backgroundImage: `url('images/background.png')`}}
      >
        <main className="w-10/12 md:w-10/12 text-center mt-10 pb-10 md:text-left">
        ...
        <div id="list-container" className="md:pl-4 m-md:grid md:grid-cols-3 lg:grid-cols-5 md:gap-0 flex flex-col gap-10 sm:grid sm:grid-cols-2">
          {list.map( item => (
            <Card character={ item }/>
          ))}
        </div>
