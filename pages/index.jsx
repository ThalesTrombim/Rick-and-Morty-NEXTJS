...
export default function Home({ list }){
  return (
    <div id="Container" className="text-white w-full h-auto bg-homebg-dark flex flex-col">
      ...
      >
        <main className="w-10/12 md:w-2/3 text-center mt-10 pb-10 md:text-left md:mx-auto md:mt-40">
        ...
        <div id="list-container" className="md:w-2/3 md:mx-auto px-4 m-md:grid md:grid-cols-3 lg:grid-cols-5 md:gap-5 flex flex-col gap-10 sm:grid sm:grid-cols-2">
          {list.map( item => (
            <Card character={ item }/>
          ))}
        </div>
